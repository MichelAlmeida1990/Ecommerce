        ...
        try {
          ...
          if (db) {
            try {
              ...
              console.log('Firestore não disponível, usando dados do Firebase Auth')
            }
          }
          ...
          if (error.message === 'Firebase não configurado') {
            message = 'Firebase não configurado. Verifique as variáveis de ambiente.'
        ...
        try {
          ...
          if (db) {
            try {
              ...
              console.log('Firestore não disponível, dados salvos apenas no Firebase Auth')
            }
          }
